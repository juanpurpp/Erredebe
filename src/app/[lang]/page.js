  ...
  return (
    <main className="flex h-screen flex-col p-0.5 bg-light_background">
      ...
      <div className="flex justify-center items-center h-full">
        <div className="p-1 sm:p-0 flex max-w-3xl justify-center items-center flex-col w-full h-full space-y-2">
          <div className="flex flex-col sm:flex-row justify-center items-center sm:space-x-10">
            ...
            <div className="flex flex-col justify-center items-center max-w-xl space-y-4">
              <h1 className="w-full text-center sm:text-left text-4xl font-bold">{title}</h1>
              <h2 className="w-full text-center sm:text-left text-lg font-light">{description}</h2>
            </div>
          </div>
